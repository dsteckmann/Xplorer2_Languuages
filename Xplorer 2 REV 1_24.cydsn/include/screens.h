...
extern CONST_LCDSTRING m_mode_1[]  ;
extern CONST_LCDSTRING m_mode_2[]  ;
extern CONST_LCDSTRING m_mode_3[]  ;
extern CONST_LCDSTRING m_mode_4[]  ;
extern CONST_LCDSTRING m_mode_5[]  ;
extern CONST_LCDSTRING m_proj_menu_1[]  ;
extern CONST_LCDSTRING m_proj_menu_2[]  ;
extern CONST_LCDSTRING m_proj_menu_3[]  ;
extern CONST_LCDSTRING m_proj_menu_4[]  ;
extern CONST_LCDSTRING m_proj_menu_5[]  ;
extern CONST_LCDSTRING Enter_to_Select[] ;
extern CONST_LCDSTRING_PTR s_up_down_select_text[]  ;
extern CONST_LCDSTRING mYES_to_Accept[] ;
extern CONST_LCDSTRING_PTR s_EnterCalibration[ ] ;
extern CONST_LCDSTRING_PTR s_UpDownYesEsc_txt[ ] ;
extern CONST_LCDSTRING  mEnter_to_Accept[]  ;
extern CONST_LCDSTRING_PTR s_extended_count[ ]  ;
extern CONST_LCDSTRING_PTR s_TestName[ ] ;
extern CONST_LCDSTRING_PTR s_newserial[ ]  ;
extern CONST_LCDSTRING_PTR s_EnterCurrent[ ]  ;
extern CONST_LCDSTRING_PTR s_ProjectExists[ ] ;
extern CONST_LCDSTRING  mPress_YES_or_NO[]  ;
extern CONST_LCDSTRING_PTR s_SerialNumber[ ] ;
//extern  ;
//extern  ;
//extern  ;
//extern  ;
